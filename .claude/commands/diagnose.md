...
```bash
CMM_PROJECT_ID="${CMM_PROJECT_ID}" CMM_STORE_PATH="${CMM_STORE_PATH}" cd "/Users/sazankhalid/Downloads/cmm/cognitive-memory" && source "/Users/sazankhalid/Downloads/cmm/.claude/cmm-env.sh" && "$CMM_PYTHON" -m src.delivery.cli_query diagnose "$ARGUMENTS"
```
